...
//Principais variáveis do jogo
	...
	var velocidadeIni1=6;
	var velocidadeIni2=4;
...
//Função que movimenta o fundo do jogo
	...
	function moveinimigo1() {
		...
		$("#inimigo1").css("left",posicaoX-velocidadeIni1);
	...
	$("#inimigo2").css("left",posicaoX-velocidadeIni2);
	...
	function colisao() {
		...
		if (colisao3.length>0) {
			...
			pontos=pontos+(10*velocidadeIni1);
			velocidadeIni1=velocidadeIni1+0.3;
		...
		if (colisao4.length>0) {
			...
			pontos=pontos+(10*velocidadeIni2);
			velocidadeIni2=velocidadeIni2+0.5;
		...
		if (colisao5.length>0) {
			...
			somResgate.play();
			salvos++;
			pontos=pontos+(50*salvos);
			velocidadeAmigo=velocidadeAmigo+0.3;
